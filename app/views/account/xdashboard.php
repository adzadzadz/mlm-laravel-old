...
<h4><strong style="color: red; ">Direct Referrals:  <?= $direct_upline_count ?> </strong> <br>Note: You must have at least 2 direct referrals to qualify for the incentives.</h4>
</div>  
                ...
                <div id="collapsethree" class="panel-collapse collapse in">
                  <div class="panel-body unilevel">
                    ...
                    <li role="presentation" class="active"><a href="#unilevel-statement-content" aria-controls="unilevel-statement-content" role="tab" data-toggle="tab">UNILEVEL</a></li>
                      <li role="presentation" id="cns-statement-trigger"><a href="#cns-statement-content" aria-controls="cns-statement-content" role="tab" data-toggle="tab" >PBB 150</a></li>
					  <!--<li role="presentation" class="active"><a href="#cns-statement-content" aria-controls="cns-statement-content" role="tab" data-toggle="tab">TPL</a></li>-->
                    </ul>
                    <div class="tab-content">
                     <div role="tabpanel" class="tab-pane active" id="cns-statement-content">
                        <div class="text-center">
                          <img class="loader" src='<?= asset("assets/imgs/loading-img.gif") ?>' alt="Loading" />
                        </div>
                      </div>
